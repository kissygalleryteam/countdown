...
gallery/countdown/1.3/countdown
...
KISSY.add('gallery/countdown/1.3/countdown',function (S, Node, Base, JSON, Timer) {
    ...
    S.extend(Countdown, Base,
        /** @lends Countdown.prototype*/{
            ...
            _getLeft: function () {//{{{
                ...
                var end = this.get('stopPoint') * 1000;
                if (!left && end) {
                    left = end - S.now();
                }
             ...
             */
            _repaint: function () {//{{{
                Countdown.Effect[this.get('effect')].paint.apply(this);
...
/**
 * @fileoverview Countdown index
 * @author jide<jide@taobao.com>
 * @module countdown
 **/
KISSY.add('gallery/countdown/1.3/index',function (S, Countdown, Effect) {
    Countdown.Effect = Effect;

    return Countdown;
}, {requires:['./countdown', './effect', './index.css']});
